...
let cardTest = [];
let cards = ["sin", "sin", "cos", "cos", "choi", "choi", "game", "game", "ga", "ga"
  , "vai", "vai", "ca", "ca", "chuong", "chuong"];
...
function createCards() {
  for (let card of shuffledCards) {
      ...
      const cardText = document.createTextNode(card); // Create a text node with the card name
...
function win() {
  ...
  if (s % 60 < 10) {
      stats.textContent = "You won with: " + stars + " stars in " + movesCounter + " moves with time: " + m + ":0" + s % 60 + ".Hehe hpbd sincos choi game ga vai ca chuong";
  } else {
      stats.textContent = "You won with: " + stars + " stars in " + movesCounter + " moves with time: " + m + ":" + s % 60 + ".Hehe hpbd sincos choi game ga vai ca chuong";
  }
}
